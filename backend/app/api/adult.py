...
async def generate_adult_video(
    ...
    if is_wan22_model:
        ...
        if not wan22_url:
            # Fallback: use fal.ai Wan 2.1 instead of dedicated Wan 2.2 backend
            ...
            is_wan22_model = False  # fall through to normal flow below

    if is_wan22_model:
        wan22_url = getattr(settings, "wan22_comfyui_url", "") or os.environ.get("WAN22_COMFYUI_URL", "")
        try:
