...
const TOOLS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Image Transitions", desc: "Upload 2-5 images → AI creates smooth transition video between them", href: "/transitions", icon: "🔀", badge: "New" },
  ...
  },
  {
    ...
    items: [
      { name: "Daily Challenge", desc: "New theme every day. Create your best image. Community votes for the winner", href: "/daily-challenge", icon: "📅", badge: "New" },
